...
public:
	...
	template <class X>
	interval(const interval<X> &a) /*: low(_IT(a.lower())), high( _IT(a.upper())) */
	{
...
template <class _IT, class _X>
inline interval<_IT> operator+(const interval<_IT> &, const _X &);
template <class _IT, class _X>
inline interval<_IT> operator+(const _X &, const interval<_IT> &);
...
template <class _IT>
interval<_IT> operator+(const interval<_IT> &, const interval<_IT> &);
template <class _IT>
interval<_IT> operator+(const interval<_IT> &); // Unary
...
template <class _IT>
bool operator==(const interval<_IT> &, const interval<_IT> &);
template <class _IT>
bool operator!=(const interval<_IT> &, const interval<_IT> &);

// Other functions
template <class _IT>
interval<_IT> abs(const interval<_IT> &);
...
//
template <class _Ty>
inline std::ostream &operator<<(std::ostream &strm, interval<_Ty> &a) { return strm << "[" << a.lower() << "," << a.upper() << "]"; }
...
//
template <class _IT>
inline interval<_IT> &interval<_IT>::operator=(const interval<_IT> &a)
{
	low = a.lower();
	high = a.upper();
	return *this;
...
//
template <class _IT>
inline interval<_IT> &interval<_IT>::operator/=(const interval<_IT> &b)
{
	interval<_IT> a, c;
...
inline interval<int> &interval<int>::operator/=(const interval<int> &b)
{
	...
	low = (int)std::floor(c.lower());
	high = (int)std::ceil(c.upper());
...
//
template <class _IT, class _X>
inline interval<_IT> operator+(const interval<_IT> &a, const _X &b)
{
	interval<_IT> c(a);
...
//
template <class _IT, class _X>
inline interval<_IT> operator+(const _X &a, const interval<_IT> &b)
{
	interval<_IT> c(b);
...
//
template <class _IT>
inline interval<_IT> operator+(const interval<_IT> &a, const interval<_IT> &b)
{
	interval<_IT> c(a);
...
//
template <class _IT>
inline interval<_IT> operator+(const interval<_IT> &a)
{
	return a;
}
...
template <class _IT>
inline bool operator==(const interval<_IT> &a, const interval<_IT> &b)
{
...
template <class _IT>
inline interval<_IT> abs(const interval<_IT> &a)
{
	if (a.lower() >= _IT(0))
		return a;
	else if (a.upper() <= _IT(0))
